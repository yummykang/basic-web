...
public class ServletResponse implements HttpServletResponse {
    ...
    public ServletResponse(FullHttpResponse response, ChannelHandlerContext ctx) {
    ...
    public PrintWriter getWriter() throws IOException {
        return new PrintWriter(new OutputStreamFacade(response.content()), true);
    }
